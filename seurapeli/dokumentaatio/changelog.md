...
-olemassa on pakka joka on sekoitettu randomisti
-Koodiin on lisätty kaksi luokkaa "Deck" ja "Card" 
...
-Pelaajan nostamien ja sille alussa jaetun kortin summa näkyy ruudulla
-Jakajan kortit näkyvät ruudun oikealla puolella ja niiden summa näkyy näytöllä (lopullisessa versiossa summa paljastuu vasta kierroksen lopussa)
...
-Korjasin edellämainitun bugin sekä tein lisäominaisuuden peliin, joka tallentaa levylle tietoa ja pitää kirjaa pelaajan parhaimmasta suorituksesta (high score).
